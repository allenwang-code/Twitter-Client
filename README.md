# Project 4 - Cunstom Twitter Client

Cunstom Twitter Client is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='http://i.imgur.com/DHi5p0a.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
otto, retrofit2, okhttp, glide, titter kit

## License

    Copyright 2017 AllenWang
